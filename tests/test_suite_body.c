...
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 0), (vector_t){2, 5.0
//       / 3.0}));
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 1), (vector_t){1, 8.0
//       / 3.0}));
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 2), (vector_t){0, 5.0
//       / 3.0}));
//   list_free(shape);
...
//   assert(list_size(shape) == 3);
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 0), (vector_t){4.0 / 3.0,
//       3}));
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 1), (vector_t){1.0 / 3.0,
//       2}));
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 2), (vector_t){4.0 / 3.0,
//       1}));
//   list_free(shape);
...
//   assert(list_size(shape) == 3);
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 0), (vector_t){10.0 / 3.0,
//       5}));
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 1), (vector_t){7.0 / 3.0,
//       4}));
//   assert(
//       vec_isclose(*(vector_t *)list_get(shape, 2), (vector_t){10.0 / 3.0,
//       3}));
//   list_free(shape);
//   body_free(body);
// }
