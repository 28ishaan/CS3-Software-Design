...
// list_t *make_square()
// {
// 	list_t *sq = list_init(4, list_free);
...
// 	assert(void_equal(*list_get(sq, 0), (vector_t){3, 4}));
// 	assert(vec_equal(*list_get(sq, 1), (vector_t){1, 4}));
// 	assert(vec_equal(*list_get(sq, 2), (vector_t){1, 2}));
// 	assert(vec_equal(*list_get(sq, 3), (vector_t){3, 2}));
// 	assert(isclose(polygon_area(sq), 4));
...
// 	assert(vec_isclose(*list_get(sq, 0), (vector_t){0, sqrt(2)}));
// 	assert(vec_isclose(*list_get(sq, 1), (vector_t){-sqrt(2), 0}));
// 	assert(vec_isclose(*list_get(sq, 2), (vector_t){0, -sqrt(2)}));
// 	assert(vec_isclose(*list_get(sq, 3), (vector_t){sqrt(2), 0}));
// 	assert(isclose(polygon_area(sq), 4));
// 	assert(vec_isclose(polygon_centroid(sq), VEC_ZERO));
// 	list_free(sq);
// }
...
// {
// 	list_t *tri = list_init(3, list_free);
// 	vector_t *v = malloc(sizeof(*v));
// 	*v = VEC_ZERO;
// 	list_add(tri, v);
// 	v = malloc(sizeof(*v));
...
// 	assert(vec_equal(*list_get(tri, 0), (vector_t){-4, -3}));
// 	assert(vec_equal(*list_get(tri, 1), (vector_t){0, -3}));
// 	assert(vec_equal(*list_get(tri, 2), (vector_t){0, 0}));
// 	assert(isclose(polygon_area(tri), 6));
...
// 	assert(vec_isclose(*list_get(tri, 0), (vector_t){-1, 3}));
// 	assert(vec_isclose(*list_get(tri, 1), (vector_t){2.2, 0.6}));
// 	assert(vec_isclose(*list_get(tri, 2), (vector_t){4, 3}));
// 	assert(isclose(polygon_area(tri), 6));
// 	assert(vec_isclose(polygon_centroid(tri), (vector_t){26.0
// / 15.0, 2.2}));
...
// {
// 	list_t *c = list_init(CIRC_NPOINTS, list_free);
...
// 	{
// 		double angle = 2 * M_PI * i / CIRC_NPOINTS;
// 		assert(vec_isclose(*list_get(c, i),
// 						   (vector_t){100 + cos(angle),
// 200
// + sin(angle)}));
// 	}
// 	assert(isclose(polygon_area(c), CIRC_AREA));
...
// 		double angle = 2 * M_PI * i / CIRC_NPOINTS;
// 		assert(
// 			vec_isclose(*list_get(c, i), (vector_t){cos(angle +
// ROT_ANGLE),
// sin(angle + ROT_ANGLE)}));
// 	}
// 	assert(isclose(polygon_area(c), CIRC_AREA));
...
// list_t *make_weird()
// {
// 	list_t *w = list_init(5, list_free);
// 	vector_t *v = malloc(sizeof(*v));
// 	*v = VEC_ZERO;
// 	list_add(w, v);
// 	v = malloc(sizeof(*v));
...
// 	assert(vec_isclose(*list_get(w, 0), (vector_t){-10, -20}));
// 	assert(vec_isclose(*list_get(w, 1), (vector_t){-6, -19}));
// 	assert(vec_isclose(*list_get(w, 2), (vector_t){-12, -19}));
// 	assert(vec_isclose(*list_get(w, 3), (vector_t){-15, -15}));
// 	assert(vec_isclose(*list_get(w, 4), (vector_t){-11, -28}));
// 	assert(isclose(polygon_area(w), 23));
// 	assert(vec_isclose(polygon_centroid(w),
// 					   (vector_t){-1603.0 / 138.0, -971.0
// / 46.0}));
...
// 	assert(vec_isclose(*list_get(w, 0), (vector_t){2, 2}));
// 	assert(vec_isclose(*list_get(w, 1), (vector_t){1, 6}));
// 	assert(vec_isclose(*list_get(w, 2), (vector_t){1, 0}));
// 	assert(vec_isclose(*list_get(w, 3), (vector_t){-3, -3}));
// 	assert(vec_isclose(*list_get(w, 4), (vector_t){10, 1}));
// 	assert(isclose(polygon_area(w), 23));
// 	assert(
// 		vec_isclose(polygon_centroid(w), (vector_t){143.0 / 46.0, 53.0 /
// 138.0}));
